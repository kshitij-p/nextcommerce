...
const EditableHoverButton = React.forwardRef(
  (
    ...
    return (
      <button
        {...rest}
        className={`visible ml-2 align-baseline opacity-25 transition-all duration-300 group-hover:visible group-hover:opacity-100 group-focus:visible group-focus:opacity-100 xl:invisible xl:opacity-0 ${className}`}
        ref={passedRef}
      >
